...
-- at runtime using the environment variable skoczki_bindir.
...
-- environment variable skoczki_libdir.
...
-- using the environment variable skoczki_dynlibdir.
...
-- runtime using the environment variable skoczki_datadir.
...
-- using the environment variable skoczki_sysconfdir.
...
bindir     = "/Users/jakubkoszorz/.cabal/bin"
libdir     = "/Users/jakubkoszorz/.cabal/lib/aarch64-osx-ghc-9.14.1-ea4f/skoczki-0.1.0.0-inplace-skoczki-tests"
dynlibdir  = "/Users/jakubkoszorz/.cabal/lib/aarch64-osx-ghc-9.14.1-ea4f"
datadir    = "/Users/jakubkoszorz/.cabal/share/aarch64-osx-ghc-9.14.1-ea4f/skoczki-0.1.0.0"
libexecdir = "/Users/jakubkoszorz/.cabal/libexec/aarch64-osx-ghc-9.14.1-ea4f/skoczki-0.1.0.0"
sysconfdir = "/Users/jakubkoszorz/.cabal/etc"

getBinDir     = catchIO (getEnv "skoczki_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "skoczki_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "skoczki_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "skoczki_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "skoczki_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "skoczki_sysconfdir") (\_ -> return sysconfdir)
